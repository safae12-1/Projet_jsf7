...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        ms.create(new Machine("HP", "HZ23", 5000, new Date(), ss.getById(4)));
        ms.create(new Machine("HP", "HZ77", 4500, new Date(), ss.getById(4)));
        ms.create(new Machine("TOSHIBA", "AZ34", 6000, new Date(), ss.getById(5)));
